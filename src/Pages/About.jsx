  ...
  return (
    ...
    <section id="about">
          <div className='nameContact'>
            ...
            <ul>
              <li>
                <a title='Perfil de Linkedin' href='https://www.linkedin.com/in/juan-m-argibay-gonzalez/'>{darkMode === 'light'? <LinkedinLogo/> : <LinkedinLogoDark/>}</a>
              </li>
              <li>
                <a title='Repositorio de GitHub' href='https://github.com/JuanArgibay'>{darkMode === 'light'? <GitHubLogo/> : <GitHubLogoDark/>}</a>
              </li>
            </ul>
          </div>
