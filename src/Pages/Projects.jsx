                ...
                <img src={parejas} alt='Parejas'></img>
                  ...
                  <h3>Descubre la pareja</h3>
                    <div className='projectLinksContainer'>
                      <a href='https://github.com/JuanArgibay/Encuentra-la-pareja'>Github</a>
                      <a href='https://encuentralapareja.vercel.app/'>Website</a>
                    </div>
                  <details>
                    <summary></summary>
            ...
            <article className='projectCard'>
              <div className='card-content'>
                <img  src={instagram} alt='instagram'></img>
                  ...
                  <div >
                    <div className='projectLinksContainer'>
                      <a href='https://github.com/JuanArgibay/Instagram-Pro-FrontEnd'>Github</a>
                      <a href='https://www.youtube.com/watch?v=cF04GUGUXTo&t=1s'>Website</a>
                    </div>
                    <details>
                      <summary></summary>
            ...
            <article className='projectCard'>
              <div className='card-content'>
                <img src={poke} alt='pokeApi'></img>
                  ...
                  <div>
                    <div className='projectLinksContainer'>
                      <a href='https://github.com/JuanArgibay/PokeApp'>Github</a>
                      <a href='https://poke-app-cyny.vercel.app/'>Website</a>
                    </div>
                    <details>
                    <summary></summary>
